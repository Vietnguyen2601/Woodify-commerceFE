...
export default function HeroSection({
  ...
  const hasBanners = bannerUrls.length > 0
  const slides = hasBanners ? bannerUrls : []
  ...
  return (
    <section
      className={`relative w-full h-[500px] ${
        !hasBanners ? 'bg-gradient-to-br from-[#c4a574] via-[#a88962] to-[#6b5344]' : ''
      }`}
    >
      {hasBanners ? (
        <img
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#c4a574] via-[#a88962] to-[#6b5344]" aria-hidden />
      )}
