...
export default function Shop() {
  ...
  if (shopError) {
    return (
      <div className='flex items-center justify-center min-h-screen bg-stone-100'>
        <p className='text-red-600'>Lỗi tải thông tin shop</p>
      </div>
    )
  }
  ...
  return (
    <div className='relative min-h-screen w-full bg-stone-100'>
      {/* SHOP HEADER BACKGROUND - Cover Image */}
      {shop?.coverImageUrl && (
      ...
      <div className='w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-40 pb-8'>
            ...
            <div className='flex-1'>
              ...
              <div className='grid grid-cols-6 gap-4 mb-4'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <div>
                    ...
                    <p className='text-yellow-800 text-sm font-bold'>{shop?.totalOrders ?? 0}</p>
                  </div>
                </div>
                <div className='flex items-center gap-2'>
                  <div className='w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center'>
                  ...
                  <div>
                    ...
                    <p className='text-yellow-800 text-sm font-bold'>{shop?.reviewCount ?? 0}</p>
                  </div>
                </div>
                <div className='flex items-center gap-2'>
                  <div className='w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center'>
              ...
              <div className='bg-gray-50 rounded-lg p-3'>
                ...
                <p className='text-gray-600 text-xs mt-2'>
                  📍 {shop?.defaultPickupAddress || 'Địa chỉ chưa cập nhật'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className='flex gap-6 bg-white rounded-b-lg p-6'>
          ...
          <aside className='w-48 flex-shrink-0 hidden lg:block'>
            ...
            {/* Search */}
            <div className='mb-4'>
              <label className='text-xs font-bold text-gray-700 block mb-2'>Tìm kiếm</label>
              <input
                type='text'
                placeholder='Nhập tên sản phẩm...'
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className='w-full px-3 py-2 border border-gray-200 rounded text-xs focus:outline-none focus:border-yellow-800'
              />
            </div>
            ...
            <button
              ...
              className='w-full px-3 py-2 rounded text-xs font-medium hover:opacity-90 transition-opacity'
